...
public class GmailOperations {
	...
	public static void sendEmail(Context context) throws IOException, GeneralSecurityException, MessagingException {
		
		Gmail service = GmailAPI.getGmailService(context);
		MimeMessage Mimemessage = createEmail("quangtuan202@gmail.com","quangtuan202@gmail.com","This my demo test subject","This is my body text");
	...
	public static void sendEmailWithAttachment(Context context) throws IOException, GeneralSecurityException, MessagingException {
	...
	public static void sendEmailWithHTMLBodyAndAttachment(Context context) throws IOException, AddressException, MessagingException, GeneralSecurityException {
		...
		Gmail service = GmailAPI.getGmailService(context);
		MimeMessage Mimemessage = createHTMLEmailBodyWithAttachment("quangtuan202@gmail.com,abc@gmail.com", "This is a subject test", htmlText, "./result.html");
